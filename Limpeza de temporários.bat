...
cls
title Deletando %Systemroot%\Prefetch
if exist "%Systemroot%\Prefetch" echo Deletando....
if exist "%Systemroot%\Prefetch" cd "%Systemroot%\Prefetch"
if exist "%Systemroot%\Prefetch" del *.* /F /S /Q /A: R /A: H /A: A
if exist "%Systemroot%\Prefetch" rmdir /s /q "%Systemroot%\Prefetch"
